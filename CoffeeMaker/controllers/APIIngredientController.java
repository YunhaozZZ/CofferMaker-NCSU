...
public class APIIngredientController extends APIController {
    ...
    /**
     * Endpoint that grab all known ingredients
     *
     * @return response to the request
     */
    ...
    public ResponseEntity createIngredient ( @RequestBody final Ingredient ingredient ) {
        ...
        System.out.println( "Ingredient created: " + ingredient.getName() );

        return new ResponseEntity( ingredient, HttpStatus.OK );
    }

    /**
     * Endpoint that deletes an ingredient
     *
     * @param name
     *            - name of ingredient
     * @return response to the request
    ...
    public ResponseEntity deleteIngredient ( @PathVariable final String name ) {
        ...
        if ( current == null ) {
            return new ResponseEntity( name + "Does Not Exists", HttpStatus.NOT_FOUND );
        }
